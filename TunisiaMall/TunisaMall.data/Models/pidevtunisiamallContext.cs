...
{
    public partial class pidevtunisiamallContext : DbContext
    {
        static pidevtunisiamallContext()
        {
            Database.SetInitializer<pidevtunisiamallContext>(null);
        }

        public pidevtunisiamallContext()
            : base("Name=pidevtunisiamallContext")
        {
        }

        public DbSet<anonimousrating> anonimousratings { get; set; }
        ...
        {
            modelBuilder.Configurations.Add(new anonimousratingMap());
